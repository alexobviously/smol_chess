...
import 'package:smol_chess/cubits/ws_cubit.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<WsCubit, WsState>(
      bloc: wsc,
            ...
            children: [
              Align(
                ...
                child: IconButton(
                  ...
                  onPressed: () => wsc.sendMessage(DateTime.now().millisecondsSinceEpoch.toString()),
                ),
              ),
              Column(
                children: [
